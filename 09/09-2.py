...
def extrapolator(sequence):
    ...
    # print("Adding first of the sequence and subtracting return from recursive call to return to caller")
    # print(str(sequence[0]) + " - " + str(recursive_call) + " = " + str(sequence[0] - recursive_call))
    return sequence[0] - recursive_call
